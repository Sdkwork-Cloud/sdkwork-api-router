...
const externalReleaseDependencySpecCatalog = createStrictKeyedCatalog({
  ...
  Object.freeze({
    ...
    expectedGitRoot: path.resolve(rootDir, '..', 'craw-chat', 'sdks', 'sdkwork-im-sdk'),
    cloneTargetDir: path.resolve(rootDir, '..', 'craw-chat', 'sdks', 'sdkwork-im-sdk'),
    requiredPaths: Object.freeze(['sdkwork-im-sdk-typescript/package.json']),
  }),
  ],
  getKey: (spec) => spec.id,
