...
export function createProductCheckPlan({
  ...
  return [
    ...
    },
    {
      ...
      command: nodeCommand,
      args: [path.join(workspaceRoot, 'scripts', 'run-user-center-standard.mjs')],
      cwd: workspaceRoot,
      env: baseEnv,
      shell: false,
      windowsHide: platform === 'win32',
    ...
    {
      label: 'desktop tauri capability audit',
      command: nodeCommand,
      args: [path.join(workspaceRoot, 'scripts', 'check-tauri-capabilities.mjs')],
      cwd: workspaceRoot,
      env: baseEnv,
      shell: false,
      windowsHide: platform === 'win32',
    ...
    {
      label: 'browser storage governance audit',
      command: nodeCommand,
      args: [path.join(workspaceRoot, 'scripts', 'check-browser-storage-governance.mjs')],
      cwd: workspaceRoot,
      env: baseEnv,
      shell: false,
      windowsHide: platform === 'win32',
    ...
    {
      label: 'product source tracking audit',
      command: nodeCommand,
      args: [path.join(workspaceRoot, 'scripts', 'check-product-source-tracking.mjs')],
      cwd: workspaceRoot,
      env: baseEnv,
      shell: false,
      windowsHide: platform === 'win32',
