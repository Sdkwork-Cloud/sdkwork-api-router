...
pub(super) fn quota_exceeded_response(project_id: &str, evaluation: &QuotaCheckResult) -> Response {
...
pub(super) fn bad_gateway_openai_response(message: impl Into<String>) -> Response {
...
pub(super) fn invalid_request_openai_response(
