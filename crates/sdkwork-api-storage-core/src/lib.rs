...
define_admin_store_facet!(BillingStore {
    ...
    async fn apply_commerce_order_quota_effect(&self, order_id: &str, project_id: &str, target_kind: &str, target_units: u64) -> bool;
    async fn consume_live_coupon_for_commerce_order(&self, order_id: &str, coupon_id: &str) -> bool;
    async fn upsert_project_membership_for_commerce_order(&self, order_id: &str, membership: &ProjectMembershipRecord) -> bool;
});
