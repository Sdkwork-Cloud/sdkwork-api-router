...
const englishSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Capability Matrix', link: '/api-reference/gateway-capabilities/matrix' },
      { text: 'Audio Families', link: '/api-reference/gateway-capabilities/audio' },
...
const chineseSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '能力矩阵', link: '/zh/api-reference/gateway-capabilities/matrix' },
      { text: 'Audio 家族', link: '/zh/api-reference/gateway-capabilities/audio' },
